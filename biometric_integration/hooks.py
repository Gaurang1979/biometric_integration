...
scheduler_events = {
    "cron": {
        # Direct multi-device sync, every 15 minutes. Each device's own
        # "Sync Lookback (minutes)" controls how much overlap is re-checked,
        # so a missed run is self-healing. Adjust the interval per your
    ...
    # fields that were never added to the Settings doctype, and direct
    # per-device polling above supersedes it. The module is left in the repo
    # for reference only.
# 	"all": [
